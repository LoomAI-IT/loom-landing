...
const objections = [
    ...
    // Блок 2: Альтернативы
    {
        ...
        answer: 'Месяц работы L👀m значительно дешевле зарплаты SMM. AI работает 24/7 и создаёт контент мгновенно. Также инструмент разгружает специалиста от рутины — он сможет сфокусироваться на стратегии',
    },
    {
        type: 'alternative',
        icon: Zap,
