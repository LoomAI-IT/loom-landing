            ...
            <Container>
                <div className={styles.content}>
                    <div className={styles.textContent}>
                        ...
                        >
                            AI создаёт профессиональный контент, пока вы занимаетесь бизнесом
                        </motion.p>
                        ...
                        >
                            {[
                                {value: '5 мин', label: 'до первого поста и контент-плана'},
                                {value: '60 сек', label: 'на создание поста'},
                                {value: '1 клик', label: 'для публикации в разные соцсети'},
                                {value: '∞', label: 'постов в месяц'},
                                {value: '10x', label: 'рост продуктивности SMM'},
