import {Lightbulb, TrendingUp, Megaphone, HelpCircle, ShieldAlert, BookOpen} from 'lucide-react';
...
const microJobs = [
    ...
    {
        icon: BookOpen,
        title: 'Создать обучающий материал',
        description: 'Научите аудиторию чему-то полезному и укрепите доверие',
    },
];
